...
const EmptyState = ({
  ...
  return <div className="flex flex-col items-center justify-center text-center py-24 my-8">
      ...
      {!filtered && <div className="flex gap-3">
          <Button onClick={onCreateNew} className="gap-2 from-blue-600/80 to-purple-600/80 hover:from-blue-600 hover:to-purple-600 bg-[151a38] text-[151a38]">
            <Sparkles size={16} />
            Create New Asset
          </Button>
        </div>}
